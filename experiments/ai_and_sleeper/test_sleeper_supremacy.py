# -*- coding: utf-8 -*-
"""
Demonstração Matemática: Supremacia do Sleeper vs Punição ao Agressivo
======================================================================
1. Agressivo: Sabota na R1/R2 -> Revela a dupla de traidores -> Os 3 Banqueiros se unem em comitês de 3 e vencem 4x2 (WR Agressivo ~10-15%).
2. Sleeper: Joga limpo na R1/R2 -> Banqueiros NÃO sabem quem são os 3 leais -> Chairman Banqueiro convoca o Sleeper achando que é leal -> Sleeper sabota de dentro nas R3, R4, R5 (WR Sleeper ~50-55%).
"""
...
# Comitês de 3 nos Tiers 3, 4, 5, 6, 7
SEVEN_TIERS_CATALOG = {
    1: [
        ...
        for idx, p in enumerate(planning_order):
            ...
            if p.role == Role.INTERN:
                if p.profile == InternProfile.A_AGGRESSIVE:
                    ...
                    # Infiltração Profunda: Coopera nas R1 e R2, ataca a partir da R3
...
for i in range(n):
    ...
    res = simulate_game(i, prof, seed=777111 + i)
    results.append(res)
