# -*- coding: utf-8 -*-
"""
BTG Madagascar - Eliminação do Convite a Traidores & Punição Real ao Agressivo
"""
...
def choose_optimal_committee(
    ...
    # Prioridade ABSOLUTA: Jogadores Limpos (suspeita < 0.60 e NÃO conhecidos como traidores)
    ...
    # Ordenação por CONFIANÇA PRIMEIRO:
    # 1. Menor suspeita média (NÃO convidar traidores!)
    # 2. Viabilidade de pontos
    # 3. Presença do Chairman
...
for i in range(n):
    ...
    res = simulate_game(i, prof, seed=666000 + i)
    results.append(res)
