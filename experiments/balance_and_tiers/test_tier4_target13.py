# -*- coding: utf-8 -*-
"""
Teste de Calibragem do Tier 4 (Target 13 pts) para Garantir Sabotagem e Eliminar 4x0
"""
...
# Ajusta o catálogo para o Tier 4 exigir 13 pts (4 ops x 1 carta, exigindo esforço real)
TIERS_CATALOG_CLIMAX_T4 = {
    ...
    4: [
        ContractSpec("Refino Metalurgico (Megasindicato)", 4, committee_size=4, cost_per_player=1, target_value=13, req_commodity=CardType.TI, req_commodity_count=2),
        ContractSpec("Consorcio Agro-Industrial (Megasindicato)", 4, committee_size=4, cost_per_player=1, target_value=13, req_commodity=CardType.VN, req_commodity_count=2),
    ],
    5: [
...
btg_simulation.SEVEN_TIERS_CATALOG = TIERS_CATALOG_CLIMAX_T4
...
for i in range(n):
    ...
    res = simulate_game(i, prof, seed=991000 + i)
    results.append(res)
