# -*- coding: utf-8 -*-
"""
Teste de Resolução do Veto e Balanceamento de Tiers
"""
...
def simulate_game(game_idx: int, profile: InternProfile, seed: Optional[int] = None) -> Dict:
    ...
    for r_idx, contract in enumerate(ops):
        ...
        # Se 3 propostas foram vetadas, o Chairman da 3ª rodada passa a bola para uma votação de desempate
        # onde a maioria de Banqueiros escolhe a proposta com menor suspeita média da mesa
        if approved_committee is None:
            # Seleciona os 3 mais limpos da perspectiva média dos jogadores
