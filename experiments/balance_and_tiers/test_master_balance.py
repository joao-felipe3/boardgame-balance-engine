# -*- coding: utf-8 -*-
"""
Equilíbrio Mestre: Punição ao Agressivo (WR ~20%) & Supremacia do Sleeper (WR ~48%)
==================================================================================
"""
        ...
        for idx, p in enumerate(planning_order):
            ...
            if p.role == Role.INTERN:
                if p.profile == InternProfile.A_AGGRESSIVE:
                    ...
                    # Sleeper coopera nas R1 e R2, e inicia sabotagens táticas diluídas a partir da R3
