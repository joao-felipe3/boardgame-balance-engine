...
def generate_trace_dataset(
    ...
    all_traces = {
        ...
        'opportunist_game': format_trace(g4, InternProfile.D_OPPORTUNIST, seeds['opportunist']),
        'technician_game': format_trace(g5, InternProfile.E_TECHNICIAN, seeds['technician'])
    }
